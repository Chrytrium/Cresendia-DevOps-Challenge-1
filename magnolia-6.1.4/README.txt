...
This package contains:
   ...
   Magnolia Core 6.1.4
   magnolia-empty-webapp 6.1.4
   magnolia-empty-webapp 6.1.4
   Magnolia Internationalization Framework 6.1.4
   Magnolia JAAS 6.1.4
   Magnolia Mail module 5.5.2
   magnolia-module-rssaggregator 2.6.2
   Magnolia Rendering 6.1.4
   Magnolia Templating 6.1.4
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.1.4.html
...
Copyright 2019 Magnolia International Ltd.
